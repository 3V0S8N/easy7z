...
void CInfo::Save() const
{
  ...
  // Easy7zip: store path history in FM key instead of Extraction\PathHistory
  key.Close();
...
void CInfo::Load()
{
  ...
  // Easy7zip: resilient against missing Extraction key; load paths from FM key
...
{
  // Easy7zip defaults: non-cascaded menu with icons enabled
  Cascaded.Val = false;
  Cascaded.Def = false;
